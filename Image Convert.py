...
def jpgtopng():
    ...
    Head.pack(pady=10)
    # To get jpg file
    browse_jpg = Button(text="      Import JPG File     ", bg='#BB2CD9', fg='white', font=('helvetica', 15, 'bold'),
                        command=getjpgfile)
    ...
    # Image in bottom
    bottom_pic = Image.open('C:\\Users\\Soundar\\Pictures\\ISTQB.jpg')
...
def pngtojpg():
    ...
    Head.pack(pady=10)
    # To get jpg file
    browse_jpg = Button(text="      Import PNG File     ", bg='#2B2B52', fg='white', font=('helvetica', 15, 'bold'),
                        command=getpngfile)
    browse_jpg.pack(pady=20)
    # To save jpg file
...
# Image
img = Image.open('C:\\Users\\Soundar\\Pictures\\ISTQB.jpg')
